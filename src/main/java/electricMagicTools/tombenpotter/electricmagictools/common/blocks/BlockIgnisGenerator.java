...
public class BlockIgnisGenerator extends BlockContainer {

	public BlockIgnisGenerator(int id, Material par2Material) {
	...
	public void registerIcons(IconRegister icon) {
		...
		frontIcon = icon
				.registerIcon("electricmagictools:essentiagenerator/ignisfront");
	}

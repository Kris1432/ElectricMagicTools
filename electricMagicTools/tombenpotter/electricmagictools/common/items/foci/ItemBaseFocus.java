...
public abstract class ItemBaseFocus extends Item implements IWandFocus {
	...
	@Override
	public ItemStack onFocusRightClick(ItemStack paramItemStack,
			World paramWorld, EntityPlayer paramEntityPlayer,
	...
	public void addInformation(ItemStack stack, EntityPlayer player, List list,
		...
		if (cost != null && cost.size() > 0) {
			...
			for (Aspect aspect : cost.getAspectsSorted()) {
				...
				list.add(" " + '\u00a7' + aspect.getChatcolor()
						+ aspect.getName() + '\u00a7' + "r x " + amount);
			}
		}
	}
}

...
public class BlockAuramGenerator extends BlockContainer {

	public BlockAuramGenerator(int id, Material par2Material) {
	...
	public void registerIcons(IconRegister icon) {
		...
		frontIcon = icon
				.registerIcon("electricmagictools:essentiagenerator/auramfront");
	}

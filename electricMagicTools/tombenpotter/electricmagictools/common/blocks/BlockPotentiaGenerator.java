...
public class BlockPotentiaGenerator extends BlockContainer {

	public BlockPotentiaGenerator(int id, Material par2Material) {
	...
	public void registerIcons(IconRegister icon) {
		...
		frontIcon = icon
				.registerIcon("electricmagictools:essentiagenerator/potentiafront");
	}

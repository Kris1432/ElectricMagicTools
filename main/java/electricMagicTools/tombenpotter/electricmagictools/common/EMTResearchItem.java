...
public class EMTResearchItem extends ResearchItem {
	...
	public EMTResearchItem(String par1, String par2, AspectList tags, int par3,
	...
	public String getText() {
		return StatCollector.translateToLocal("[EMT] ")
				+ StatCollector.translateToLocal("emt.tag." + key);
	}

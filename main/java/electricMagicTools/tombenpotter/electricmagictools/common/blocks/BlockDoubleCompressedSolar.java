...
public class BlockDoubleCompressedSolar extends BlockContainer {

	public BlockDoubleCompressedSolar(int par1) {
	...
	public void registerIcons(IconRegister icon) {
		topIcon = icon
				.registerIcon("electricmagictools:essentiagenerator/doublesolartop");
		bottomIcon = icon
